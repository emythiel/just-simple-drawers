...
public class ServerConfig {
    ...
    private static final ModConfigSpec.IntValue RANGE_BASE;
    ...
    static {
        ...
        COMPACTING_BASE_CAPACITY = builder
            .comment(
                ...
                "This capacity is applied to the most compressed item stored"
            )
            .defineInRange("compactingBaseCapacity", 8, 1, 256);
        ...
        RANGE_BASE = builder
            .comment("Sets the controllers network range in blocks")
        ...
        RANGE_UPGRADE_T5_MULTIPLIER = builder
            ...
            .defineInRange("rangeUpgradeT5Mult", 16, 1, 32);
